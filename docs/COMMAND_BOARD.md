...
- Queue-position scope (system-wide vs. per-vehicle-type) — should be system-wide per the one-driver reality above; confirm explicitly in the backend logic comment when 5.4 is built
