    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.data?.length > 0) {
          setConsultingDoctorId(data.data[0].id);
        }
      }
    } catch (error) {
  ...
  const toggleService = (key) => {
    setServicesUsed(prev => {
      if (prev.includes(key)) {
        // Remove service and clear its ratings/booleans
...
const styles = StyleSheet.create({
  ...
  header:             { paddingTop: 48, paddingHorizontal: 20, paddingBottom: 16, backgroundColor: '#ffffff', borderBottomWidth: 1, borderBottomColor: '#e2e8f0', marginBottom: 8 },
  ...
  sectionLabel:       { fontSize: 13, fontWeight: '700', color: '#3182ce', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 20, marginBottom: 8, paddingHorizontal: 20 },
  ...
  input:              { backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: '#2d3748', marginHorizontal: 20, marginBottom: 14 },
  ...
  ratingRow:          { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, marginBottom: 14, backgroundColor: '#ffffff', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#f0f4f8' },
  ...
  serviceSection:     { marginTop: 12, marginHorizontal: 20, backgroundColor: '#ffffff', borderRadius: 12, padding: 16, marginBottom: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 3, elevation: 2 },
