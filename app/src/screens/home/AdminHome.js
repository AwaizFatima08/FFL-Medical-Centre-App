...
const styles = StyleSheet.create({
  ...
  tile: {
    width: 108, height: 108, backgroundColor: '#ffffff',
    borderRadius: 12, justifyContent: 'center',
    alignItems: 'center', padding: 8, position: 'relative',
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.08, shadowRadius: 4, elevation: 3,
  },
  tileDisabled:      { backgroundColor: '#edf2f7', shadowOpacity: 0, elevation: 0 },
  tileIcon:          { fontSize: 28, marginBottom: 6 },
  tileLabel:         { fontSize: 11, fontWeight: '600', color: '#2d3748', textAlign: 'center' },
  tileLabelDisabled: { color: '#a0aec0' },
  comingSoon:        { fontSize: 9, color: '#a0aec0', marginTop: 3, fontStyle: 'italic' },
  badge: {
