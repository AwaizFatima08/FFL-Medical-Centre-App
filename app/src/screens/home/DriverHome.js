...
// navigation prop added — required for NotificationBell
export default function DriverHome({ navigation }) {
  ...
  return (
    <View style={styles.wrapper}>
      {/* Blue header bar — bell sits between title block and logout button */}
      <View style={styles.headerBar}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerRight}>
            <NotificationBell navigation={navigation} bellStyle={styles.bellOnBlue} />
...
const styles = StyleSheet.create({
  ...
  // Override bell icon colour to white so it's visible on the blue background
  bellOnBlue:   { tintColor: '#ffffff' },
  logoutBtn: {
